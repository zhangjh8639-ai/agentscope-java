 ...
 * delegates execution to {@link io.agentscope.builder.runtime.gateway.Gateway}.
 *
 * <p>Each implementation handles one channel protocol:
 *
 * <ul>
 *   <li>{@link io.agentscope.builder.runtime.channel.chatui.ChatUiChannel} — direct programmatic / Chat UI
 ...
 *       BuilderBootstrap#start} to inject the auto-wired
 ...
 *
 * Implementations call {@link io.agentscope.builder.runtime.gateway.Gateway#run} with the {@link
 * io.agentscope.builder.runtime.gateway.MsgContext} produced by {@link ChannelRouter#resolveRoute}. The
 * returned {@link Msg} reply is delivered back to the originating platform by the channel adapter.
 *
 * @see ChannelConfig
 * @see ChannelRouter
 * @see io.agentscope.builder.runtime.gateway.Gateway
 */
public interface Channel {
    ...
    /**
     * Called by {@link BuilderBootstrap#start} before {@link
