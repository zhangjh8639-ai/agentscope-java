 ...
 *
 * <p>The {@code peerId} is used by {@link io.agentscope.builder.runtime.channel.ChannelRouter} to build a
 * stable session key:
 *
 * <ul>
 *   <li>If {@code peerId} is null (or blank) and the channel's {@link
 *       io.agentscope.builder.runtime.channel.DmScope} is {@link
 *       io.agentscope.builder.runtime.channel.DmScope#MAIN}, all requests without a peer share the same
 ...
 *       io.agentscope.builder.runtime.channel.DmScope#PER_PEER} or similar scopes).
 * </ul>
 *
