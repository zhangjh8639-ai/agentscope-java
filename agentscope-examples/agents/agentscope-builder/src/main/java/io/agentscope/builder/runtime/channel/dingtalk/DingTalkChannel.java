 ...
 */
package io.agentscope.builder.runtime.channel.dingtalk;
...
import io.agentscope.builder.runtime.channel.common.BotLoopGuard;
import io.agentscope.builder.runtime.channel.common.IdempotencyStore;
...
public final class DingTalkChannel implements Channel {
    ...
    /** {@code type} value used in {@code agentscope.json} and {@link io.agentscope.builder.runtime.config.ChannelTypeRegistry}. */
    ...
    /** Factory used by {@link io.agentscope.builder.runtime.config.ChannelTypeRegistry}. */
