...
export default function AgentRail() {
  ...
  return (
    <div style={{
      ...
      <Section title="Built-in" agents={builtin} activeId={activeId} navigate={navigate} loading={loading} err={err} />
      <Section title="Custom" agents={custom} activeId={activeId} navigate={navigate} loading={loading} err={null} />
    </div>
  );
}
