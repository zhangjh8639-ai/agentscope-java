 ...
 */
package io.agentscope.harness.coding.channel;
 ...
 * delegates execution to {@link io.agentscope.harness.coding.gateway.Gateway}.
 *
 * <p>Each implementation handles one channel protocol:
 *
 * <ul>
 *   <li>{@link io.agentscope.harness.coding.channel.chatui.ChatUiChannel} — direct programmatic / Chat UI
 ...
 *       CodingBootstrap#start} to inject the auto-wired
 ...
 *
 * Implementations call {@link io.agentscope.harness.coding.gateway.Gateway#run} with the {@link
 * io.agentscope.harness.coding.gateway.MsgContext} produced by {@link ChannelRouter#resolveRoute}. The
 * returned {@link Msg} reply is delivered back to the originating platform by the channel adapter.
 *
 * @see ChannelConfig
 * @see ChannelRouter
 * @see io.agentscope.harness.coding.gateway.Gateway
 */
public interface Channel {
    ...
    /**
     * Called by {@link CodingBootstrap#start} before {@link
