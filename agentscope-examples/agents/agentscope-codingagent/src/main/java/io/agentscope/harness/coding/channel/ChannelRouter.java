 ...
 * "agentId"} so that {@link io.agentscope.harness.coding.gateway.HarnessGateway#run} can pick the correct
...
public final class ChannelRouter {
     ...
     *     io.agentscope.harness.coding.gateway.Gateway#bindMainAgent}
     */
     ...
     * io.agentscope.harness.coding.gateway.Gateway#run}.
     *
