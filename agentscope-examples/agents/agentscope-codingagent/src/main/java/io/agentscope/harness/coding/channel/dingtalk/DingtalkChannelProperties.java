 ...
 * @param apiBase override for the DingTalk OpenAPI base; default {@code https://api.dingtalk.com}
 * @param oapiBase override for the legacy OAPI base; default {@code https://oapi.dingtalk.com}
