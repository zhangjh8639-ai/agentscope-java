...
public class AgentscopeConfig {
     ...
     * DataAgentBootstrap.Builder#mainAgent(String)} overrides this when set.
     */
    @JsonProperty("main")
    private String main;
     ...
     * io.agentscope.dataagent.runtime.session.SessionMaintenanceConfig} and an internal scheduler for
     * daily / idle resets.
     */
