 ...
 * </pre>
 *
 * <p>DataAgent v1 does not implement the per-agent ACL tier surface; the global
 * {@code SecurityConfig} owns authentication / role enforcement for this endpoint, and
 * {@link OutboundService} performs the channel-routing-based check that prevents one agent
